...
public class TestReport implements IReporter{
	...
	private String reportTitle= "VAT Test Run";
			...
			for (ITestNGMethod method : getMethodSet(tests, suite)) {
				...
				if (!className.equalsIgnoreCase(lastClassName)) {
					if (mq > 0) {
						...
						writer.println(" width=\"100%\">" + lastClassName + "</td>" + buff);
					}
					mq = 0;
					buff.setLength(0);
				...
				buff.append("<td width=\"20%\"><a href=\"#m"
						+ m_methodIndex
						+ "\">"
						...
						+ (description != null && description.length() > 0 ? "(\""
								...
								+ (null == testInstanceName ? "" : "<br>("
										+ testInstanceName + ")") + "</td>"
										+ "<td class=\"numi\" style=\"text-align:left;padding-right:2em; width=20%\">" + firstLine+"<br/></td>"
										+ "<td style=\"text-align:right; width=20%\">" + formatter.format(calendar.getTime()) + "</td>" + "<td style=\"text-align:right; width=20%\">" + "</td>" + "<td class=\"numi\">"
	...
	private void startResultSummaryTable(String style) {
		...
		writer.println("<tr><th width=\"20%\">Class</th>"
				+ "<th width=\"20%\">Method</th><th width=\"20%\">Exception Info</th><th width=\"20%\">Start Time </th><th width=\"20%\">Execution Time<br/>(hh:mm:ss)</th></tr>");
		m_row = 0;
	}
	...
	private void resultDetail(IResultMap tests) {
		...
		for (ITestResult result : testResultsList) {
			...
			System.out.println("Result Set Size is: "+ resultSet.size());
	...
	protected void endHtml(PrintWriter out) {
		out.println("<center> Custome Report </center>");
